                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" name="type" required>
                                    <option value="private" {{ old('type') == 'private' ? 'selected' : '' }}>Privato
                                    </option>
                                    <option value="company" {{ old('type') == 'company' ? 'selected' : '' }}>Azienda
                                    </option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('fiscal_code') is-invalid @enderror"
                                    name="fiscal_code" value="{{ old('fiscal_code') }}">
                                @error('fiscal_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('license_type') is-invalid @enderror"
                                    name="license_type" value="{{ old('license_type') }}">
                                @error('license_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
